...
exports.default = {
    ...
    methods: {
        ...
        toggleError: function toggleError(day, nr) {
            day--; //coretie offset
        ...
        toggleSelected: function toggleSelected(day, nr) {
            day--; //coretie offset
            i = this.calendars[nr].firstDayOfWeek + day;
            var week = Math.floor(i / 7);
            //TODO: both!
        ...
        makeSelection: function makeSelection(element, nights) {
            var haveRooms = true;
            //debugger;
            nr = element.id[0];
        ...
        notify: function notify(direction) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-dfe19810", module.exports)
  } else {
    hotAPI.update("_v-dfe19810", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _RoomOptions = require('./RoomOptions.vue');

var _RoomOptions2 = _interopRequireDefault(_RoomOptions);

var _DateSelector = require('./DateSelector.vue');

var _DateSelector2 = _interopRequireDefault(_DateSelector);

var _ProgressIndicator = require('./ProgressIndicator.vue');
...
exports.default = {
    ...
    methods: {
        ...
        nights_add: function nights_add() {
            if (this.nights < 14) {
                this.nights++;
            }
        },
        nights_sub: function nights_sub() {
            if (this.nights > 1) {
                this.nights--;
            }
        },
    ...
    events: {
        'update-options': function updateOptions(msg) {

            this.options[msg[0]] = msg[1];
            //this. fetchData()
        },

        'update-calendar': function updateCalendar(msg) {
            if (msg == 0) {
    ...
    components: { RoomOptions: _RoomOptions2.default, DateSelector: _DateSelector2.default, ProgressIndicator: _ProgressIndicator2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
exports.default = {
    ...
    methods: {
        step: function step(_step) {
            $('ul.progress-indicator li').removeClass('completed');
            $('div[id^="step_"]').css('display', 'none');
            $('div[id^="step_' + _step + '"]').css('display', 'block');

            for (var i = 1; i <= _step; i++) {
                $('ul.progress-indicator li:nth-child(' + i + ')').addClass('completed');
            }
        }
    }
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div>\n    <ul class=\"progress-indicator\">\n        <li class=\"completed\" @click=\"step(1)\"> <span class=\"bubble\"></span> Rooms. </li>\n        <li @click=\"step(2)\"> <span class=\"bubble\"></span> Extras. </li>\n        <li @click=\"step(3)\"> <span class=\"bubble\"></span> Your details. </li>\n        <li @click=\"step(4)\"> <span class=\"bubble\"></span> Payment and confirmation. </li> </ul>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e71f1cb2", module.exports)
  } else {
    hotAPI.update("_v-e71f1cb2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    ...
    methods: {
        adults_add: function adults_add() {
            if (this.adults < 4) {
                this.adults++;
                this.notify();
            }
        },
        adults_sub: function adults_sub() {
            if (this.adults > 1) {
                this.adults--;
                this.notify();
            }
        },
        children_add: function children_add() {
            if (this.children < 10) {
                this.children++;
                this.notify();
            }
        },
        children_sub: function children_sub() {
            if (this.children > 0) {
                this.children--;
                this.notify();
            }
        },
        babies_add: function babies_add() {
            if (this.babies < 10) {
                this.babies++;
                this.notify();
            }
        },
        babies_sub: function babies_sub() {
            if (this.babies > 0) {
                this.babies--;
                this.notify();
            }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2f46e1c8", module.exports)
  } else {
    hotAPI.update("_v-2f46e1c8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _PackageSelector = require('./PackageSelector.vue');

var _PackageSelector2 = _interopRequireDefault(_PackageSelector);
...
new _vue2.default({
    el: '#vue',
    components: { PackageSelector: _PackageSelector2.default }
});

},{"./PackageSelector.vue":8,"./jquery.fittext.js":11,"./jquery.lettering.js":12,"moment":1,"vue":5,"vue-resource":4}]},{},[13]);
